...
<div class="wrap about-wrap">
  ...
  if(isset($current_theme)){
    $welcome_str = 'Welcome to Pluto v'.$current_theme->get( 'Version' );
  }else{
    $welcome_str = 'Welcome';
  }
  ...
  ?>
	...
	<div class="about-text">Congratulations! You are using the most powerful masonry grid styled blog theme on the market built for you by a great team at <a href="https://pinsupreme.com">Pinsupreme.com</a></div>
  ...
  <div class="osetin-intro-box">
    ...
    <ul>
      <li><a href="http://pluto.pinsupreme.com/docs/index.html" target="_blank">Read Documentation</a></li>
      <?php if ( !defined('ENVATO_HOSTED_SITE') ) { ?>
      <li><a href="https://pinsupreme.com/users/sign_up" target="_blank">Create Account to Manage Activations</a></li>
      <?php } ?>
      <li><a href="http://pluto.pinsupreme.com/docs/index.html#headingFaqs" target="_blank">Read FAQ</a></li>
  ...
  <div class="osetin-intro-box">
    ...
    <a href="http://pluto.pinsupreme.com/docs/index.html#headingImportingDemoDataXML" target="_blank">Learn How to Import Demo Data</a>
  </div>
