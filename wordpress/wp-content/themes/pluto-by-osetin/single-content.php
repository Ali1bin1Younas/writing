  ...
  <div class="post-body">
    <div class="single-post-top-features">
      ...
      <?php if(is_single() || isset($forse_single)): ?>
        <?php if(osetin_get_field('disable_reading_mode', 'option') != TRUE): ?>
    ...
    <?php if(is_single() || isset($forse_single)){ ?>
      <?php if(osetin_get_field('hide_featured_image_on_single_post', 'option') != true && (get_post_format() != 'quote')){ ?>
    ...
    <div class="post-content entry-content">
      ...
      <?php
        echo osetin_get_external_link_button();
      ?>
    </div>
  </div>
